...
namespace APICatalogo.Migrations
{
    ...
    public partial class PopulaProdutos2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder mb)
        {
            ...
            mb.Sql("Insert into Produtos(Nome,Descricao,Preco,ImagemUrl,Estoque,DataCadastro,CategoriaId)" +
             "Values('Pepsi','Refrigerante de Cola 350 ml',5.45,'cocacola.jpg',50,now(),1)");

            mb.Sql("Insert into Produtos(Nome,Descricao,Preco,ImagemUrl,Estoque,DataCadastro,CategoriaId)" +
                "Values('Lanche de Frango','Lanche de Frango com maionese',8.50,'frango.jpg',10,now(),2)");

            mb.Sql("Insert into Produtos(Nome,Descricao,Preco,ImagemUrl,Estoque,DataCadastro,CategoriaId)" +
               "Values('Brigadeiro 100 g','Brigadeiro 100g',6.75,'brigadeiro.jpg',20,now(),3)");

            mb.Sql("Insert into Produtos(Nome,Descricao,Preco,ImagemUrl,Estoque,DataCadastro,CategoriaId)" +
             "Values('Guarana Antartica','Refrigerante de guarana 350 ml',5.45,'cocacola.jpg',50,now(),1)");

            mb.Sql("Insert into Produtos(Nome,Descricao,Preco,ImagemUrl,Estoque,DataCadastro,CategoriaId)" +
                "Values('Lanche vegano','Lanche vegano',8.50,'vegano.jpg',10,now(),2)");

            mb.Sql("Insert into Produtos(Nome,Descricao,Preco,ImagemUrl,Estoque,DataCadastro,CategoriaId)" +
               "Values('Paçoca','Paçoca de amendoim',6.75,'pacoca.jpg',20,now(),3)");
